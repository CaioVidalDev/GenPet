<x-app-layout>
    ...
    <div class="flex items-center justify-between">
     ...
     <div class="rounded-lg border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark p-4">
            ...
            <x-mary-alert x-data="{ show: false }" x-on:servico-created.window="show = true" title="Serviço cadastrada com sucesso" description="Serviço está disponível para ser associado a outros registros" icon="o-check-circle" class="alert-success" dismissible shadow />
